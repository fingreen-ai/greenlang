...
class OecdViolations(): # pylint: disable=[too-few-public-methods]
    """ oecd_violations """
    ...
    def impact(self, collections, assets, invest_value_tot, period): # pylint: disable=[unused-argument]
        ...
        for asset in assets:
            ...
            collection_item_oecd_violations_bool = CollectionItem.objects.get(
                collection=collection, template__name='oecd_violations_bool')
            value = collection_item_oecd_violations_bool.value_boolean
