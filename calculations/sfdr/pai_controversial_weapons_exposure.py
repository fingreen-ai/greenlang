...
class ControversialWeaponsExposure(): #pylint: disable=[invalid-name, too-few-public-methods]
    """ controversial_weapons_exposure """
    ...
    def impact(self, collections, assets, invest_value_tot, period): # pylint: disable=[unused-argument]
        ...
        for asset in assets:
            ...
            collection_item_controversial_weapons_exposure_bool = CollectionItem.objects.get(
                collection=collection, template__name='controversial_weapons_exposure_bool')
            value = collection_item_controversial_weapons_exposure_bool.value_boolean
